...
> **限制就是风格。** 摄影机架在纸堆上，不飞出去：不做 3D 运镜；深度只来自图层（前景纸 + 人物赛璐珞 + 背景插画 + 图形叠加）；运动词压在 H3 官方 **20 个**以内；动感由 **2D 专属招**提供——机位锁死、画面在动。丰富的是摄影机**在看什么**（角度 / 构图 / 焦），不是它能飞多远。
